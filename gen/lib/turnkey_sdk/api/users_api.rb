...
module TurnkeyClient
  class UsersApi
    ...
    def create_api_only_users(body, opts = {})
      data, _status_code, _headers = create_api_only_users_with_http_info(body, opts)
      data
    end
    ...
    def create_api_only_users_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: UsersApi.create_api_only_users ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling UsersApi.create_api_only_users"
      end
      # resource path
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UsersApi#create_api_only_users\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
