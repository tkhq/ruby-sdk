...
module TurnkeyClient
  class OrganizationsApi
    ...
    def get_organization(body, opts = {})
      data, _status_code, _headers = get_organization_with_http_info(body, opts)
      data
    end
    ...
    def get_organization_with_http_info(body, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: OrganizationsApi.get_organization ...'
      end
      # verify the required parameter 'body' is set
      if @api_client.config.client_side_validation && body.nil?
        fail ArgumentError, "Missing the required parameter 'body' when calling OrganizationsApi.get_organization"
      end
      # resource path
