  ...
  class V1InvitationParams
    ...
    def self.attribute_map
      {
        ...
        :'receiver_user_email' => :'receiverUserEmail',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `SwaggerClient::V1InvitationParams` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `SwaggerClient::V1InvitationParams`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'receiver_user_email')
        self.receiver_user_email = attributes[:'receiver_user_email']
      end
    ...
    def list_invalid_properties
      ...
      if @receiver_user_email.nil?
        invalid_properties.push('invalid value for "receiver_user_email", receiver_user_email cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @receiver_user_email.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          receiver_user_email == o.receiver_user_email &&
    ...
    def hash
      [receiver_user_name, receiver_user_email, receiver_user_tags, access_type, sender_user_id].hash
    end
