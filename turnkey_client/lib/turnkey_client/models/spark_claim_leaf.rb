...
module TurnkeyClient
  class SparkClaimLeaf
    ...
    attr_accessor :sender_signature
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TurnkeyClient::SparkClaimLeaf` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TurnkeyClient::SparkClaimLeaf`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'sender_signature')
        self.sender_signature = attributes[:'sender_signature']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @sender_signature.nil?
        invalid_properties.push('invalid value for "sender_signature", sender_signature cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @sender_signature.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          sender_signature == o.sender_signature
    end
    ...
    def hash
      [leaf_id, ciphertext, sender_signature].hash
    end
