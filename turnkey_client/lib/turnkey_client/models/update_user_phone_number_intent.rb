  ...
  class UpdateUserPhoneNumberIntent
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `TurnkeyClient::UpdateUserPhoneNumberIntent` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `TurnkeyClient::UpdateUserPhoneNumberIntent`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @user_phone_number.nil?
        invalid_properties.push('invalid value for "user_phone_number", user_phone_number cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @user_phone_number.nil?
      true
    end
    ...
    def hash
      [user_id, user_phone_number, verification_token].hash
    end
